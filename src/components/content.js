...
function Content() {
  return (
    <div className="flex-container">
      ...
      <img className="image" src={process.env.PUBLIC_URL + "/1.png"} alt="Bildbeschreibung" />
...
<img className="image" src={process.env.PUBLIC_URL + "/2.png"} alt="Bildbeschreibung" />
...
<img className="image" src={process.env.PUBLIC_URL + "/3.png"} alt="Bildbeschreibung" />
